...
def main():
    ...
    LinkWatcherLogger(name="check1", json_logs=False)
    ...
    structlog.reset_defaults()
    assert not structlog.is_configured()
    LinkWatcherLogger(name="check1b", json_logs=True)
    ...
    LinkWatcherLogger(name="switch_a", json_logs=False)
    ...
    LinkWatcherLogger(name="switch_b", json_logs=True)
    ...
    LinkWatcherLogger(name="switch_c", json_logs=False)

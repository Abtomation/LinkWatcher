...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("Check 2: Long path NOT corrupted (no 'configs/../config.yaml')")
        ...
        print("Check 3: Long path updated to '../configs/config.yaml'")
        ...
        print("Check 4: Line 1 is 'main_config: ../config.yaml'")
        ...
        print("Check 5: Line 2 is 'nested_config: ../configs/config.yaml'")

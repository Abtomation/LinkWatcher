...
from watchdog.events import FileDeletedEvent  # noqa: E402

from linkwatcher.database import LinkDatabase  # noqa: E402
from linkwatcher.handler import LinkMaintenanceHandler  # noqa: E402
from linkwatcher.parser import LinkParser  # noqa: E402
from linkwatcher.updater import LinkUpdater  # noqa: E402
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        print("  PASS: File routed to pending_deletes (per-file move detection)")
        ...
        if dir_key in handler._dir_move_detector.pending_dir_moves:
            ...
            print(
                "  INFO: Directory had no remaining tracked files "
                "(assessment-template.md was already 'deleted')"
            )

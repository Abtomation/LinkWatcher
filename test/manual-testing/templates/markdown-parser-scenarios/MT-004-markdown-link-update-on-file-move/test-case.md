# Test Case: MT-004 Markdown Link Update on File Move
...
|-------|-------|
| Test Case ID | MT-004 |
| Group | markdown-parser-scenarios (MT-GRP-03) |
...
- [ ] **Automated comparison**: Run `Verify-TestResult.ps1 -TestCase MT-004` (if workspace not gitignored)

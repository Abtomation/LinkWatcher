...
#   2. Move (or rename) "move-target.md" to "move-target-renamed.md"
...
#      "move-target.md" have been updated to the new location
#
#   EXPECTED RESULT for Test 1:
#   - Every occurrence of "move-target.md" in this file should be updated
...
.DESCRIPTION
    ...
    - move-target.md (a markdown file)
...
# =============================================================================
# After moving move-target.md, count occurrences of the NEW path in this file.
# Expected updated references for move-target.md: 20 occurrences
# Expected updated references for move-target-2.ps1: 11 occurrences
#
# To count (PowerShell):
#   (Get-Content "test-powershell-parser-patterns.ps1" | Select-String "move-target.md").Count

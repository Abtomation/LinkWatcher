...
|-----------|------|-------------|
| MT-001 | [MT-001-regex-preserved-on-file-move/test-case.md](MT-001-regex-preserved-on-file-move/test-case.md) | Verify regex patterns in PS1 files are not rewritten when the file is moved, while real paths are still updated |

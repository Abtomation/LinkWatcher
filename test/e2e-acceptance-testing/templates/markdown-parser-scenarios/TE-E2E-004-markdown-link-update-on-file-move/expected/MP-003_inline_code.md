...
- [Real documentation](test_project/archive/readme.md)
...
**Expected Results:**
- Should find ONLY: test_project/archive/readme.md, test_project/config/settings.yaml, test_projects/root.txtt

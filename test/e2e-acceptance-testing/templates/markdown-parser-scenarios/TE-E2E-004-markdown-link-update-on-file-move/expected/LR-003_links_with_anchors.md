...
## Links with anchors:
- [Documentation section](test_project/archive/readme.md#features)
...
- [Dashed anchor](test_project/archive/readme.md#quick-links)
...
- [With anchor](test_project/archive/readme.md#documentation)
- [Another no anchor](test_project/file2.txt)

## Complex anchors:
- [Complex anchor](test_project/archive/readme.md#links-to-other-files)

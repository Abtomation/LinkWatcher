# Test Case: E2E-001 regex preserved on file move
...
5. **Compare against expected state**: Run `Verify-TestResult.ps1 -TestCase E2E-001` or manually compare the file content against `expected/scripts/update/sub/Update-Tracking.ps1`
...
- [ ] **Automated comparison**: Run `Verify-TestResult.ps1 -TestCase E2E-001` — compares workspace against `expected/`

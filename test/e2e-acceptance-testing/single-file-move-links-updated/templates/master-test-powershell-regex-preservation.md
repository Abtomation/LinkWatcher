---
id: TE-E2G-001
description: "E2E acceptance test (WF-001): powershell-regex-preservation."
type: Testing
...
2. **Verify regex patterns are unchanged and real path is updated**
   ...
   - Tool: Text editor or `Verify-TestResult.ps1 -Workflow single-file-move-links-updated`
...
- [ ] Run `Verify-TestResult.ps1 -Workflow single-file-move-links-updated` shows all green

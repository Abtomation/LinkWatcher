...
#   -------------------------------------------------------
#   1. Move (or rename) "moved/move-target-2.ps1" to "move-target-2-renamed.ps1"
#   2. Wait 10-15 seconds for LinkWatcher to process
#   3. Open this file and verify ALL paths referencing "moved/move-target-2.ps1"
#      have been updated
#
#   EXPECTED RESULT for Test 2:
#   - Every occurrence of "moved/move-target-2.ps1" should be updated
...
.DESCRIPTION
    ...
    - moved/move-target-2.ps1 (a PowerShell script)
...
# Expected updated references for moved/move-target-2.ps1: 11 occurrences
#
# To count (PowerShell):
#   (Get-Content "test-powershell-parser-patterns.ps1" | Select-String "move-target.md").Count
#   (Get-Content "test-powershell-parser-patterns.ps1" | Select-String "moved/move-target-2.ps1").Count
# =============================================================================

---
id: TE-E2E-027
description: "E2E acceptance test (WF-009): TE-E2E-027 Validate Broken Links Detected."
type: Testing
...
- [ ] Test environment set up via `Setup-TestEnvironment.ps1 -Workflow link-health-audit-broken-link-report`
...
1. **Set up test environment**: Copy fixtures to workspace
   - **Tool**: `Setup-TestEnvironment.ps1 -Workflow link-health-audit-broken-link-report`

...
- [ ] Test environment set up via `Setup-TestEnvironment.ps1 -Workflow rapid-sequential-moves-consistency`
...
- [ ] Run `Verify-TestResult.ps1 -Workflow rapid-sequential-moves-consistency` shows all green

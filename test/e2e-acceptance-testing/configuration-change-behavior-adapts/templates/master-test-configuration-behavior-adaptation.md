...
- [ ] Test environment set up via `Setup-TestEnvironment.ps1 -Workflow configuration-change-behavior-adapts`
...
- [ ] Run `Verify-TestResult.ps1 -Workflow configuration-change-behavior-adapts` shows all green

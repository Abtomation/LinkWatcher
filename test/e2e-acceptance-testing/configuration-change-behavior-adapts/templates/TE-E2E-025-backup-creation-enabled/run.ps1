# run.ps1 — Scripted action for TE-E2E-025 (backup creation enabled)
...
#
# Usage (orchestrated):
#   Run-E2EAcceptanceTest.ps1 -TestCase "TE-E2E-025" -Workflow "configuration-change-behavior-adapts"
...
try {
    ...
    # Move the target file — LinkWatcher should update refs in readme.md
    # AND create a .bak backup of readme.md before modifying it

---
id: TE-E2G-011
description: "E2E acceptance test: error-recovery."
type: Testing
...
- [ ] Test environment set up via `Setup-TestEnvironment.ps1 -Workflow graceful-shutdown-no-corrupted-files`
...
- [ ] Run `Verify-TestResult.ps1 -Workflow graceful-shutdown-no-corrupted-files` shows all green

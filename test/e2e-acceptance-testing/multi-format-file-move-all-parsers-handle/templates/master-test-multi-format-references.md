...
- [ ] Test environment set up via `Setup-TestEnvironment.ps1 -Workflow multi-format-file-move-all-parsers-handle`
...
- [ ] Run `Verify-TestResult.ps1 -Workflow multi-format-file-move-all-parsers-handle` shows all green

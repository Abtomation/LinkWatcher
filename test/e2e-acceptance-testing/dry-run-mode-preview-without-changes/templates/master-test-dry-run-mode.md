---
id: TE-E2G-009
description: "E2E acceptance test (WF-007): dry-run-mode."
type: Testing
...
- [ ] Test environment set up via `Setup-TestEnvironment.ps1 -Workflow dry-run-mode-preview-without-changes`
...
- [ ] Run `Verify-TestResult.ps1 -Workflow dry-run-mode-preview-without-changes` shows all green

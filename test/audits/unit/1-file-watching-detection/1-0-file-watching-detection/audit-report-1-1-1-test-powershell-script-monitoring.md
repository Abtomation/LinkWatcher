...
feature_id: 1.1.1
auditor: AI Agent
test_file_path: test/automated/unit/1-file-watching-detection/1-0-file-watching-detection/test_powershell_script_monitoring.py
...
| **Test File Location** | `test/automated/unit/1-file-watching-detection/1-0-file-watching-detection/test_powershell_script_monitoring.py` |
...
|-----------|----------|------------|--------|
| test_powershell_script_monitoring.py | test/automated/unit/1-file-watching-detection/1-0-file-watching-detection/test_powershell_script_monitoring.py | 5 | ✅ Tests Approved |

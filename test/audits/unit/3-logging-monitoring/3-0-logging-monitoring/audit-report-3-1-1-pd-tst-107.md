...
| **Test File Locations** | `test/automated/unit/3-logging-monitoring/3-0-logging-monitoring/test_logging.py`, `test/automated/unit/3-logging-monitoring/3-0-logging-monitoring/test_advanced_logging.py` |
...
|-----------|----------|------------|--------|
| test_logging.py | test/automated/unit/3-logging-monitoring/3-0-logging-monitoring/test_logging.py | 25 | ✅ All passing |
| test_advanced_logging.py | test/automated/unit/3-logging-monitoring/3-0-logging-monitoring/test_advanced_logging.py | 19 | ✅ All passing |

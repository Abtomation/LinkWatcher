...
class LinkChecker:
    ...
    def save_results(self, broken_by_file: Dict[str, List[BrokenLink]], output_file: str = "link_check_results.txt"):
...
def main():
    ...
    parser.add_argument("--output", default="link_check_results.txt",

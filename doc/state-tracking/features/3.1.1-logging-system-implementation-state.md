...
| --------- | ---- | -------------- | ------ | ------- |
| [test/automated/unit/test_logging.py](../../../test/automated/unit/test_logging.py) | Unit | Logger creation, formatting, filtering, timer | Existing | Pre-framework |
| [test/automated/unit/test_advanced_logging.py](../../../test/automated/unit/test_advanced_logging.py) | Unit | Advanced logging config, rotation, JSON formatting | Existing | Pre-framework |

...
| [linkwatcher/parsers/base.py](../../../../linkwatcher/parsers/base.py) | File reading, path detection | `safe_file_read()`, `looks_like_file_path()` | All 6 concrete parsers inherit via `BaseParser` — none import `utils.py` directly |

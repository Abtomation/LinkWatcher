...
| --------- | ------------ | -------- | -------- | ---------- |
| [../../../../src/linkwatcher/service.py](../../../../src/linkwatcher/service.py) | Statistics collection and reporting | Track files/links processed | Performance monitoring | N/A |
...
| --------- | -------- | ----------------- | ----- |
| [linkwatcher/logging.py](../../../../src/linkwatcher/logging.py) | Logging infrastructure | `get_logger()`, logging methods | Output statistics |
| [linkwatcher/config/settings.py](../../../../src/linkwatcher/config/settings.py) | Configuration | `LinkWatcherConfig`, `show_statistics` flag | Statistics enabled |

...
- **Business Goal**: Prevent false positives and false negatives in link detection — the foundation of accurate link updates
...
- `tests/parsers/test_markdown.py` — Markdown link syntax, anchors, inline references
- `tests/parsers/test_yaml.py` — YAML value references, nested paths
- `tests/parsers/test_json.py` — JSON string value file references
- `tests/parsers/test_python.py` — Python string literals, imports
- `tests/parsers/test_dart.py` — Dart import/export statements
- `tests/parsers/test_generic.py` — Generic text file reference extraction
- `tests/parsers/test_image_files.py` — Image file reference detection
...
- [✓] 7 parser test files covering all 6 parsers plus image files
- [✓] 80+ test methods with edge case coverage
- [✓] Uses `temp_project_dir` and `file_helper` fixtures for file creation
- [✓] Custom assertions: `assert_reference_found`, `assert_reference_not_found`
- [✓] Runnable via `python run_tests.py --parsers` or `pytest tests/parsers/`
...
- No direct dependents — parser tests validate parser implementations independently
...
| [linkwatcher/models.py](../../../../src/linkwatcher/models.py) | Data models | `LinkReference` class | Test data verification |
| [linkwatcher/parsers/markdown.py](../../../../src/linkwatcher/parsers/markdown.py) | Test target | `MarkdownParser` class | test_markdown.py |
| [linkwatcher/parsers/yaml_parser.py](../../../../src/linkwatcher/parsers/yaml_parser.py) | Test target | `YAMLParser` class | test_yaml.py |
| [linkwatcher/parsers/json_parser.py](../../../../src/linkwatcher/parsers/json_parser.py) | Test target | `JSONParser` class | test_json.py |
| [linkwatcher/parsers/python.py](../../../../src/linkwatcher/parsers/python.py) | Test target | `PythonParser` class | test_python.py |
| [linkwatcher/parsers/dart.py](../../../../src/linkwatcher/parsers/dart.py) | Test target | `DartParser` class | test_dart.py |
| [linkwatcher/parsers/generic.py](../../../../src/linkwatcher/parsers/generic.py) | Test target | `GenericParser` class | test_generic.py |
...
**Context**: Parsers are the most critical component — false positives or negatives cascade through the entire system.

...
- `json.JSONDecodeError` → `GenericParser` fallback
...
- [✓] `json.loads()` + recursive traversal
- [✓] GenericParser fallback for invalid JSON
- [✓] Line/column position computation
...
- [✓] **PF-TSK-064**: Codebase Feature Discovery
  ...
  - **Key Outputs**: Feature identified, code assigned to `src/linkwatcher/parsers/json_parser.py`
...
| -------- | ---- | ---------------- | --------- | ----- |
| ~~HOW_IT_WORKS.md~~ | Architecture Overview | JSON parser design, path value extraction | **File Removed** | Was: JSON parsing description. Content superseded by FDD PD-FDD-026 |
...
| --------- | --------- | -------------- | -------- | ---------- |
| [../../../../src/linkwatcher/parsers/json_parser.py](../../../../src/linkwatcher/parsers/json_parser.py) | JSON file reference parser | JSONParser class | Existing | N/A |
...
| --------- | -------- | ----------------- | ----- |
| [linkwatcher/parsers/base.py](../../../../src/linkwatcher/parsers/base.py) | Base class and utilities | `BaseParser`, `_safe_read_file()`, `_looks_like_file_path()`, `_find_line_number()` | Inherited |
...
| --------- | ------------------------- | ----------------- | ----- |
| [linkwatcher/parser.py](../../../../src/linkwatcher/parser.py) | Registers in parser orchestrator | `JsonParser` class | Parser registry |
| [linkwatcher/parsers/__init__.py](../../../../src/linkwatcher/parsers/__init__.py) | Exports JSON parser | `JsonParser` | Package exports |
...
- JSON comments (non-standard JSONC) are not parsed — accepted trade-off
...
- Where: `json.JSONDecodeError` catch → `GenericParser.extract_links()`

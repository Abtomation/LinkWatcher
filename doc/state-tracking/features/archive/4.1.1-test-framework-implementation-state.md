...
- test/automated/test_config.py with per-environment configurations
...
- [✓] pytest.ini with 10 custom markers (unit, integration, parser, performance, slow, manual, critical, high, medium, low)
- [✓] conftest.py with 9 shared fixtures and 2 custom assertions
- [✓] run_tests.py CLI with 10 execution modes and default quick-test fallback
- [✓] test_config.py with 4 environment configs (unit/integration/performance/manual)
- [✓] 4-directory test organization: unit/ (7 files), integration/ (9 files), parsers/ (7 files), performance/ (1 file)
...
N/A — This feature defines the test framework itself
...
- **[4.1.2 Unit Tests](./4.1.2-unit-tests-implementation-state.md)** — Uses shared fixtures from conftest.py
- **[4.1.3 Integration Tests](./4.1.3-integration-tests-implementation-state.md)** — Uses `link_service` fixture
- **[4.1.4 Parser Tests](./4.1.4-parser-tests-implementation-state.md)** — Uses `temp_project_dir`, `file_helper` fixtures
- **[4.1.5 Performance Tests](./4.1.5-performance-tests-implementation-state.md)** — Uses `temp_project_dir` fixture
- **[4.1.7 Test Utilities](./4.1.7-test-utilities-implementation-state.md)** — Custom assertions added to pytest namespace
...
| --------- | -------- | ----------------- | ----- |
| [linkwatcher/__init__.py](../../../../src/linkwatcher/__init__.py) | Core components for test fixtures | `LinkDatabase`, `LinkParser`, `LinkUpdater`, `LinkWatcherService` | Used in conftest.py |
| [linkwatcher/config/](../../../../src/linkwatcher/config) | Test configuration | `TESTING_CONFIG`, `LinkWatcherConfig` | Per-environment configs |

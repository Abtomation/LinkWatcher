...
| [linkwatcher/database.py](../../../../src/linkwatcher/database.py) | Performance testing | `LinkDatabase` class | Database operation benchmarking |
| [linkwatcher/parser.py](../../../../src/linkwatcher/parser.py) | Performance testing | `LinkParser` class | Parsing performance measurement |
| [linkwatcher/service.py](../../../../src/linkwatcher/service.py) | Performance testing | `LinkWatcherService` class | Initial scan benchmarking |
| [linkwatcher/config/__init__.py](../../../../src/linkwatcher/config/__init__.py) | Testing configuration | `DEFAULT_CONFIG` | Default settings for tests |
| [linkwatcher/models.py](../../../../src/linkwatcher/models.py) | Test data generation | `LinkReference` | Creating test references |

...
- Anchor-only links (`#section`) — these don't reference files that can move
...
- [✓] Standard inline link detection with title stripping
- [✓] Reference-style link definition detection
- [✓] Standalone path and quoted path detection
- [✓] Overlap detection preventing duplicate references
- [✓] External URL and anchor-only link skipping
...
- [✓] **PF-TSK-064**: Codebase Feature Discovery
  ...
  - **Key Outputs**: Feature identified, code assigned to `src/linkwatcher/parsers/markdown.py`
...
| -------- | ---- | ---------------- | --------- | ----- |
| ~~HOW_IT_WORKS.md~~ | Architecture Overview | Markdown link parsing, regex patterns, link types | **File Removed** | Was: markdown parser description. Content superseded by FDD PD-FDD-026 |
...
| --------- | --------- | -------------- | -------- | ---------- |
| [../../../../src/linkwatcher/parsers/markdown.py](../../../../src/linkwatcher/parsers/markdown.py) | Markdown link parser | MarkdownParser class | Existing | N/A |
...
| --------- | ------------------------- | ----------------- | ----- |
| [linkwatcher/parser.py](../../../../src/linkwatcher/parser.py) | Registers in parser orchestrator | `MarkdownParser` class | Parser registry |
| [linkwatcher/parsers/__init__.py](../../../../src/linkwatcher/parsers/__init__.py) | Exports markdown parser | `MarkdownParser` | Package exports |

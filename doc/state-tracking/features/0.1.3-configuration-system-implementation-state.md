...
> **v2.0 Consolidation**: This file replaces PF-FEA-007 (old 0.1.4 Configuration System) as part of the 42→9 feature consolidation. Feature renumbered from 0.1.4 to 0.1.3. See [Feature Consolidation State](../../../process-framework/state-tracking/temporary/old/feature-consolidation-state.md).

...
| WF-002 | Directory move → contained refs updated | Move/rename a directory | 1.1.1, 0.1.2, 2.1.1, 2.2.1 | P1 | All Implemented | 🔴 Failing | [PD-INT-006](/doc/technical/integration/directory-move-integration-narrative.md) |
| WF-003 | Startup → initial project scan | Run `python main.py` or startup script | 0.1.1, 0.1.3, 0.1.2, 2.1.1, 1.1.1, 3.1.1 | P1 | All Implemented | 🔴 Failing | [PD-INT-001](/doc/technical/integration/startup-integration-narrative.md) |
...
| WF-006 | Configuration change → behavior adapts | Edit config file or pass CLI arguments | 0.1.3, 1.1.1, 3.1.1 | P3 | All Implemented | 🔴 Failing | [PD-INT-009](/doc/technical/integration/configuration-change-integration-narrative.md) |
| WF-007 | Dry-run mode → preview without changes | Start with `--dry-run`, move files, observe logs | 0.1.3, 0.1.1, 2.2.1, 3.1.1 | P3 | All Implemented | 🔴 Failing | [PD-INT-003](/doc/technical/integration/dry-run-mode-integration-narrative.md) |

...
> **v2.0 Consolidation**: This file replaces 5 former feature states (PF-FEA-026 through PF-FEA-030, old 3.1.1–3.1.5) as part of the 42→9 feature consolidation. See [Feature Consolidation State](../../../../process-framework/state-tracking/temporary/old/feature-consolidation-state.md).
...
| TDD (PD-TDD-024) | Technical Design | Complete | [tdd-3-1-1-logging-framework-t2.md](../../technical/architecture/design-docs/tdd/tdd-3-1-1-logging-framework-t2.md) | 2026-02-20 |
...
- **Main Design**: [TDD (PD-TDD-024)](../../technical/architecture/design-docs/tdd/tdd-3-1-1-logging-framework-t2.md)

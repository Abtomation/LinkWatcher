...
> **v2.0 Consolidation**: This file replaces PF-FEA-005 (old 0.1.3 In-Memory Database) as part of the 42→9 feature consolidation. Feature renumbered from 0.1.3 to 0.1.2. See [Feature Consolidation State](../../../process-framework/state-tracking/temporary/old/feature-consolidation-state.md).
...
| TDD (PD-TDD-022) | Technical Design | Complete | [tdd-0-1-2-in-memory-database-t2.md](../../technical/architecture/design-docs/tdd/tdd-0-1-2-in-memory-database-t2.md) | 2026-02-20 |
| ADR (PD-ADR-040) | Architecture Decision | Complete | [target-indexed-in-memory-link-database.md](../../technical/architecture/design-docs/adr/adr/target-indexed-in-memory-link-database.md) | 2026-02-20 |
...
- **Main Design**: [TDD (PD-TDD-022)](../../technical/architecture/design-docs/tdd/tdd-0-1-2-in-memory-database-t2.md)
- **ADR**: [PD-ADR-040](../../technical/architecture/design-docs/adr/adr/target-indexed-in-memory-link-database.md)
...
| --------- | ------- | -------------- | ------ | ------- |
| [linkwatcher/database.py](../../../../linkwatcher/database.py) | In-memory link storage | `LinkDatabaseInterface` ABC (10 abstract methods + last_scan property) + `LinkDatabase` concrete class — target-indexed dict, Lock, CRUD ops, 3-level resolution | Existing | Pre-framework |

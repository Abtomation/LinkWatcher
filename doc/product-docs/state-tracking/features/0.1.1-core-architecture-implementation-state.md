...
| TDD (PD-TDD-021) | Technical Design | Complete | [tdd-0-1-1-core-architecture-t3.md](../../technical/architecture/design-docs/tdd/tdd-0-1-1-core-architecture-t3.md) | 2026-02-20 |
| ADR (PD-ADR-039) | Architecture Decision | Complete | [orchestrator-facade-pattern.md](../../technical/architecture/design-docs/adr/adr/orchestrator-facade-pattern-for-core-architecture.md) | 2026-02-20 |
...
- **Main Design**: [TDD (PD-TDD-021)](../../technical/architecture/design-docs/tdd/tdd-0-1-1-core-architecture-t3.md)
...
| [test/automated/integration/test_comprehensive_file_monitoring.py](../../../../test/automated/integration/test_comprehensive_file_monitoring.py) | Integration | End-to-end service operation | Existing | Pre-framework |

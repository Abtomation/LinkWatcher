...
> **🔗 Link**: [FDD PD-FDD-024](../../../../functional-design/fdds/fdd-1-1-2-event-handler.md) — Event Handler Functional Design Document
...
- `linkwatcher/database.py` (0.1.3) — link database
- `linkwatcher/parser.py` (2.1.1) — file parser
- `linkwatcher/updater.py` (2.2.1) — link updater
- `linkwatcher/utils.py` (0.1.5) — path utilities

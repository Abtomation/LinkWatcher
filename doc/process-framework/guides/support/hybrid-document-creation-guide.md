...
../../scripts/file-creation/03-testing/New-TestFile.ps1 -TestName "UserAuth" -TestType "Unit" -ComponentName "AuthService"

# Creates test/integration/test_loginflow.py with comment metadata
../../scripts/file-creation/03-testing/New-TestFile.ps1 -TestName "LoginFlow" -TestType "Integration" -ComponentName "LoginFlow"
```
...
```
doc/process-framework/templates/[SUBFOLDER]/component-template.js
```

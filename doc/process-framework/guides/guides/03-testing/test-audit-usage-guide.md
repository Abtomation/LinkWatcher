...
**Solution:**
1. Verify you're running the script from the correct directory: `doc/process-framework/scripts/file-creation/`
...
- [Test Audits Directory](../../../../product-docs/test-audits/README.md) - Directory structure and usage

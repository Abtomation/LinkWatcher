...
Refer to [Foundation Feature Implementation Usage Guide](../04-implementation/foundation-feature-implementation-usage-guide.md) for detailed mode selection criteria and transition patterns.

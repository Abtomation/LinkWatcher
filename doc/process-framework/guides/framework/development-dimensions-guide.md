...
- [Feature Validation Guide](/doc/process-framework/guides/05-validation/feature-validation-guide.md) — Scoring methodology and thresholds for validation rounds
- [Proposal: Dimension-Aware Development Integration (PF-PRO-013)](/doc/process-framework/proposals/proposals/dimension-aware-development-integration-proposal.md) — Design rationale and decision log

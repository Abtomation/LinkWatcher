...
| A-2 | documentation-map.md still lists test-implementation-map.md context map — references a visualization for a potentially deprecated task | Low | documentation-map.md |

...
def cmd_file(entries, file_path):
    ...
    print(f"Cross-cutting:  {', '.join(match['cross_cutting']) if match['cross_cutting'] else '(none)'}")
...
def main():
    ...
    group.add_argument("--feature", metavar="ID", help="Show tests covering a feature (e.g., 0.1.1)")
    group.add_argument("--type", metavar="TYPE", help="Show tests of a type (unit/integration/parser/performance)")

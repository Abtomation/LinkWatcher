...
if ($Variant -eq "ProcessImprovement") {
    ...
    $successDetails = @(
        ...
        "",
        "📖 CUSTOMIZATION GUIDE:",
        "doc/process-framework/guides/support/temp-state-tracking-customization-guide.md",

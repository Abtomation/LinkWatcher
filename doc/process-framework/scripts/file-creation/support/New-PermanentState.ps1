...
try {
    ...
    $templatePath = Join-Path $projectRoot "doc/process-framework/templates/support/state-file-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "doc/process-framework/guides/support/state-file-creation-guide.md",

...
try {
    ...
    $templatePath = Join-Path $projectRoot "doc/process-framework/templates/04-implementation/feature-implementation-state-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "",
            "📖 COMPREHENSIVE GUIDE:",
            "doc/process-framework/guides/04-implementation/feature-implementation-state-tracking-guide.md",

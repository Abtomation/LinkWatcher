...
if ($Lightweight) {
    $templatePath = "doc/process-framework/templates/06-maintenance/lightweight-refactoring-plan-template.md"
    $modeLabel = "Lightweight"
} elseif ($DocumentationOnly) {
    $templatePath = "doc/process-framework/templates/06-maintenance/documentation-refactoring-plan-template.md"
    $modeLabel = "Documentation-only"
} else {
    $templatePath = "doc/process-framework/templates/06-maintenance/refactoring-plan-template.md"
    $modeLabel = "Standard"
}
    ...
    if (-not $OpenInEditor) {
        if ($Lightweight) {
            ...
            $details += @(
                ...
                "doc/process-framework/guides/06-maintenance/code-refactoring-task-usage-guide.md",

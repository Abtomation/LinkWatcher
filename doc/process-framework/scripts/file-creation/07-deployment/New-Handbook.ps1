...
.NOTES
    ...
    - Template: doc/process-framework/templates/07-deployment/handbook-template.md (PF-TEM-065)
#>
...
try {
    ...
    $templatePath = Join-Path $projectRoot "doc/process-framework/templates/07-deployment/handbook-template.md"

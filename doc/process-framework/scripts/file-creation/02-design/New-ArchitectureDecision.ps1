...
try {
    ...
    $templatePath = Join-Path $projectRoot "doc/process-framework/templates/02-design/adr-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "doc/process-framework/guides/02-design/architecture-decision-creation-guide.md",

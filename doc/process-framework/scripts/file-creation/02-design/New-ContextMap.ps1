...
try {
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "doc/process-framework/guides/support/visualization-creation-guide.md",
            "doc/process-framework/guides/support/visual-notation-guide.md",

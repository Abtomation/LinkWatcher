...
try {
    ...
    $templatePath = Join-Path $projectRoot "doc/process-framework/templates/02-design/api-specification-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "doc/process-framework/guides/02-design/api-specification-creation-guide.md",

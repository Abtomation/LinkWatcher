...
try {
    ...
    $templatePath = Join-Path $projectRoot "doc/process-framework/templates/02-design/api-data-model-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "doc/process-framework/guides/02-design/api-data-model-creation-guide.md",

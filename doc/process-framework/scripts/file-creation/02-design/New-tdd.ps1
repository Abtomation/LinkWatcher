...
$templatePaths = @{
    "1" = Join-Path $projectRoot "doc/process-framework/templates/02-design/tdd-t1-template.md"
    "2" = Join-Path $projectRoot "doc/process-framework/templates/02-design/tdd-t2-template.md"
    "3" = Join-Path $projectRoot "doc/process-framework/templates/02-design/tdd-t3-template.md"
}
...
try {
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "",
            "📖 REQUIRED READING:",
            "doc/process-framework/guides/02-design/tdd-creation-guide.md",

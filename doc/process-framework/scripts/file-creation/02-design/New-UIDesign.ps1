...
try {
    ...
    $templatePath = Join-Path (Get-ProjectRoot) "doc/process-framework/templates/02-design/ui-design-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "doc/process-framework/guides/02-design/ui-design-customization-guide.md",
...
- Verify doc/process-framework/guides/02-design/ui-design-customization-guide.md exists for user guidance

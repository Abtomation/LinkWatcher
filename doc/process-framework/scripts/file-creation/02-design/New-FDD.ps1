...
try {
    ...
    $templatePath = Join-Path (Get-ProjectRoot) "doc/process-framework/templates/02-design/fdd-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "doc/process-framework/guides/02-design/fdd-customization-guide.md",
...
- Verify doc/process-framework/guides/02-design/fdd-customization-guide.md exists for user guidance

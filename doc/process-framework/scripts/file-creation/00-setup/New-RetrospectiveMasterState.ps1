...
$templatePath = Join-Path $projectRoot "doc/process-framework/templates/00-setup/retrospective-state-template.md"
...
try {
    ...
    $details = @(
        ...
        "",
        "📖 TASK DEFINITION:",
        "doc/process-framework/tasks/00-setup/codebase-feature-discovery.md",
        "",

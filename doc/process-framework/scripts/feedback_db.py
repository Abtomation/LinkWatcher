...
Usage:
    python doc/process-framework/scripts/feedback_db.py init
    python doc/process-framework/scripts/feedback_db.py record --json forms.json
    python doc/process-framework/scripts/feedback_db.py log-change --tool PF-TSK-009 --date 2026-02-26 --imp IMP-038 --description "Streamlined from 27 to 14 steps"
    python doc/process-framework/scripts/feedback_db.py query --task PF-TSK-009
    python doc/process-framework/scripts/feedback_db.py query --tool PF-TSK-007
    python doc/process-framework/scripts/feedback_db.py query --all
    python doc/process-framework/scripts/feedback_db.py report
    python doc/process-framework/scripts/feedback_db.py report --task PF-TSK-009
"""
...
DB_DEFAULT_PATH = (
    Path(__file__).resolve().parent.parent / "feedback" / "ratings.db"
)

...
- The New-FeedbackForm.ps1 script parameter values are not intuitive (e.g., "MultipleTools" not "Multiple Tools") and documentation in doc/process-framework/ai-tasks.md uses the wrong format with spaces
...
4. Fix the feedback form documentation in doc/process-framework/ai-tasks.md to show correct parameter format: `"MultipleTools"` not `"Multiple Tools"`
...
- [ ] Fix New-FeedbackForm.ps1 parameter documentation in doc/process-framework/ai-tasks.md (FeedbackType values)

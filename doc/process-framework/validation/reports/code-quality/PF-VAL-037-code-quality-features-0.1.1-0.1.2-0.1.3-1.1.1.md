...
1. **Continue handler.py decomposition (TD005)**
   ...
   - **Dependencies**: Existing refactoring plan in `doc/process-framework/refactoring/plans/decompose-handle-file-moved-mega-method-into-focused-sub-methods.md`
...
2. **Migrate print() to logger across service.py and handler.py (TD026)**
   ...
   - **Dependencies**: Existing refactoring plan in `doc/process-framework/refactoring/plans/remove-dual-print-logger-output-in-updater-py.md`

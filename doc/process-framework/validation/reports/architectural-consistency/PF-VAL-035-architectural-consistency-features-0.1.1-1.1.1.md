...
1. **Handler continued decomposition** → TD022 (new — TD005 is resolved)
   ...
   - **Planning Notes**: Original decomposition plan at `doc/process-framework/refactoring/plans/decompose-god-class-linkmaintenancehandler-td005.md` — reference_lookup.py extraction still pending

...
| ID | Feature | Status | Priority | Doc Tier | FDD | TDD | Test Status | Test Spec | Dependencies | Notes |
| -- | ------- | ------ | -------- | -------- | --- | --- | ----------- | --------- | ------------ | ----- |
| [6.1.1](../features/6.1.1-Link%20Validation-implementation-state.md) | Link Validation | 📊 Assessment Created | P2 | [Unknown](../../../product-docs/documentation-tiers/assessments/ART-ASS-200-6.1.1-link-validation.md) | N/A | — | ⬜ | — | 0.1.1, 2.1.1 | On-demand workspace scanner that checks all existing links across all supported file formats and reports broken references. New feature.; Assessment completed: ART-ASS-200 (2026-03-16); Recommended: Unknown; Complexity: Assessment |
...
|----------|--------|---------|-------|
| FDDs | 8 | 2 (0.1.3 Configuration System — Tier 1, not required) | |
| TDDs | 8 | 2 (0.1.3 Configuration System — Tier 1, not required) | |
| ADRs | 2 | — | PD-ADR-039 (0.1.1), PD-ADR-040 (0.1.2) |
| Test Specs | 9 | 1 | |
| Tier Assessments | 9 | 1 | |

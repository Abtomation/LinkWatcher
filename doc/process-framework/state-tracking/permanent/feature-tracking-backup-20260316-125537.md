...
|----------|--------|---------|-------|
| FDDs | 8 | 2 (0.1.3 Configuration System and 6.1.1 Link Validation — Tier 1, not required) | |
| TDDs | 8 | 2 (0.1.3 Configuration System and 6.1.1 Link Validation — Tier 1, not required) | |
| ADRs | 2 | — | PD-ADR-039 (0.1.1), PD-ADR-040 (0.1.2) |
| Test Specs | 9 | 1 (6.1.1 Link Validation — not yet created) | |

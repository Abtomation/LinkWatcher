...
# Create new ADR
../../scripts/file-creation/02-design/New-ArchitectureDecision.ps1 -Title "Repository Pattern for Data Access" -Status "Proposed"
```
...
### Essential Guides
- [Architectural Framework Usage Guide](../../guides/01-planning/architectural-framework-usage-guide.md) - **START HERE**: Comprehensive guide for using the architectural framework
- [Task Transition Guide](../../guides/framework/task-transition-guide.md) - Workflow patterns including architectural transitions

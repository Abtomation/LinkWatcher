...
| --------- | ------- | -------------- | ------ | ------- |
| [linkwatcher/database.py](../../../../linkwatcher/database.py) | In-memory link storage | `LinkDatabase` class — target-indexed dict, Lock, CRUD ops, 3-level resolution | Existing | Pre-framework |

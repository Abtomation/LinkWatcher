...
| --------- | ------- | -------------- | ------ | ------- |
| [linkwatcher/updater.py](../../../../linkwatcher/updater.py) | Link update engine | `LinkUpdater` class — path calc, atomic write, backup, dry-run, anchor preservation | Existing | Pre-framework |

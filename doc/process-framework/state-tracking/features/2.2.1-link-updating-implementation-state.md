...
| --------- | ---- | -------------- | ------ | ------- |
| [tests/unit/test_updater.py](../../../../test/automated/unit/test_updater.py) | Unit | Path calculation, replacement, backup, dry-run | Existing | Pre-framework |
| [tests/integration/test_link_updates.py](../../../../test/automated/integration/test_link_updates.py) | Integration | End-to-end update scenarios | Existing | Pre-framework |

...
| tests/unit/test_advanced_logging.py | Unit | Advanced logging config, rotation | Existing | Pre-framework |
| tests/unit/test_lock_file.py | Unit | Lock file management | Existing | Pre-framework |
| tests/unit/test_parser.py | Unit | Parser facade dispatch, registry | Existing | Pre-framework |

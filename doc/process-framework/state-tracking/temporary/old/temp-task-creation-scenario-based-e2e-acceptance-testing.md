...
- [ ] Create User Workflow Map (`doc/product-docs/technical/design/user-workflow-map.md`)
...
**Script bug fixed during session**: `New-TempTaskState.ps1` had garbled template path (`doc/product-docs/templates/templates/` → `doc/process-framework/templates/support/`)
...
- **Workflow map location**: `doc/product-docs/technical/design/user-workflow-map.md` — product design artifact, sibling to feature-dependencies.md. One per project, no separate template/script.

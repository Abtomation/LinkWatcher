...
- **Change ID**: SC-006
- **Proposal Document**: [Structure Change Proposal (PF-PRO-006)](/doc/process-framework/proposals/proposals/old/structure-change-test-directory-consolidation-and-framework-integration-proposal.md)
...
| Guide (new) | `test-infrastructure-guide.md` | `doc/process-framework/guides/03-testing` | Create — explains test/ structure | MEDIUM |
...
- [x] **Create test infrastructure guide**
  ...
  - **Location**: `doc/process-framework/guides/03-testing/test-infrastructure-guide.md`
...
- [x] **Update test-tracking.md audit report paths**
  - **Status**: COMPLETED
  - **Changes**: All `../../../../product-docs/test-audits/` → `../../../../test/audits/` (bulk replace)
...
- [x] **Test Tracking**: All `../../../../product-docs/test-audits/` → `../../../../test/audits/`
  - **Status**: COMPLETED

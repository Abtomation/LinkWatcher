...
|-----------|-------|------------------|---------------------|-------|
| Task definitions | 2 | doc/process-framework/tasks/03-testing/ | COMPLEX | PF-TSK-069, PF-TSK-070 — rename files + extensive content updates |
| Guides | 3 | doc/process-framework/guides/03-testing/ | COMPLEX | Customization guide, test infrastructure guide, test implementation guide |
...
| Directory | scripts/test/manual-testing/ | doc/process-framework/scripts/test/ | Rename → scripts/test/e2e-acceptance-testing/ | CRITICAL |

...
- `doc/process-framework/guides/guides/development-guide.md` — Full adaptation: Riverpod → generic, Supabase → generic, Dart examples → Python, Escape Room sections → generic, pubspec.yaml → requirements.txt

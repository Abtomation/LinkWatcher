...
- **Change ID**: SC-008
- **Proposal Document**: [Structure Change Proposal PF-PRO-011](/doc/process-framework/proposals/proposals/old/structure-change-split-id-registry-into-framework-and-product-registries-proposal.md)
...
- [x] **Structure Change Proposal**: PF-PRO-011 created and approved
  - **Status**: COMPLETED
  - **Location**: [Proposal](/doc/process-framework/proposals/proposals/old/structure-change-split-id-registry-into-framework-and-product-registries-proposal.md)

- [x] **Move id-registry.json**: Move `doc/id-registry.json` → `doc/process-framework/PF-id-registry.json`
  - **Status**: COMPLETED
...
- [x] **Remove feedback README**: Delete `doc/process-framework/feedback/README.md` (PF-FEE-000)
  - **Status**: COMPLETED
...
**Completed**:
- Moved doc/id-registry.json → doc/process-framework/PF-id-registry.json

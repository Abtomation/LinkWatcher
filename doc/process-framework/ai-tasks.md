...
| Task                                  | Use When                                                                                            | Complexity | Link                                                                                                     |
| ------------------------------------- | --------------------------------------------------------------------------------------------------- | ---------- | -------------------------------------------------------------------------------------------------------- |
| **Core Logic Implementation** | General-purpose coding task for non-foundation features: create modules, wire integration points, write tracked unit tests | 🟡 Medium | [→ Definition](/doc/process-framework/tasks/04-implementation/core-logic-implementation.md) |
...
| **State Management Implementation** | Implement state management layer connecting data layer to UI layer | 🟡 Medium | [→ Definition](/doc/process-framework/tasks/04-implementation/state-management-implementation.md) |

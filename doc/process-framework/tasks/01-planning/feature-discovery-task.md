...
- **Critical (Must Read):**
  ...
  - [Feature Granularity Guide](/doc/process-framework/guides/guides/01-planning/feature-granularity-guide.md) - Defines what constitutes a well-scoped feature with validation tests
  - [Development Guide](/doc/process-framework/guides/guides/04-implementation/development-guide.md) - Development standards and practices
...
8. For each potential feature:
   - Validate granularity using the three tests in the [Feature Granularity Guide](/doc/process-framework/guides/guides/01-planning/feature-granularity-guide.md) (planning test, conversation test, independence test)
...
- [ ] **Complete Feedback Forms**: Follow the [Feedback Form Completion Instructions](../../guides/guides/framework/feedback-form-completion-instructions.md) for each tool used, using task ID "PF-TSK-013" and context "Feature Discovery"
...
- [Feature Granularity Guide](/doc/process-framework/guides/guides/01-planning/feature-granularity-guide.md) - Defines what constitutes a well-scoped feature with validation tests and scaling guidance

...
- **Important (Load If Space):**
  ...
  - [Development Guide](/doc/process-framework/guides/04-implementation/development-guide.md) - Coding best practices and conventions
...
- **Reference Only (Access When Needed):**
  ...
  - [Bug Reporting Guide](/doc/process-framework/guides/06-maintenance/bug-reporting-guide.md) - For documenting bugs discovered during implementation
...
11. **Update Feature Tracking**: Update [Feature Tracking](../../../product-docs/state-tracking/permanent/feature-tracking.md) status to 🧪 Testing (feature is implemented and undergoing testing)
...
- [Feature Implementation State Files](../../../product-docs/state-tracking/features/) - Update the feature's state file with:
...
- [Feature Tracking](../../../product-docs/state-tracking/permanent/feature-tracking.md) - Update Implementation Status to 🧪 Testing (feature is implemented and undergoing testing)
- [Bug Tracking](../../../product-docs/state-tracking/permanent/bug-tracking.md) - Add entries for any bugs discovered but not fixed in this session
...
- [ ] **Update State Files**: Ensure all state tracking files have been updated
  ...
  - [ ] [Feature Tracking](../../../product-docs/state-tracking/permanent/feature-tracking.md) status set to 🧪 Testing
...
- [ ] **Bug Documentation**: Any bugs discovered but not fixed are documented
  ...
  - [ ] [Bug Tracking](../../../product-docs/state-tracking/permanent/bug-tracking.md) updated with 🆕 Reported entries (if applicable)

...
[Optional section. Describe specific situations when this guide should be used. Include triggers, prerequisites, or decision criteria.]

> **🚨 CRITICAL**: [Add any critical warnings or requirements here]
...
[Optional section. Provide context and background information that helps the reader understand why they're performing these steps. Include any concepts they should be familiar with before proceeding.]

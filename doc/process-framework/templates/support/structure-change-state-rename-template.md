...
> **⚠️ TEMPORARY FILE**: This file tracks implementation of a rename/move structure change. Move to `doc/process-framework/state-tracking/temporary/old/` after all changes are validated.

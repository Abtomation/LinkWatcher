...
created: 2026-03-15
updated: 2026-03-15
template_for: Manual Test Case
description: Template for individual manual test case files with exact steps, preconditions, expected outcomes, and verification methods
creates_document_category: Testing
usage_context: Manual Test Case Creation Task (PF-TSK-069)
---

<!-- TEMPLATE STARTS BELOW THIS LINE -->
<!-- Copy everything below into test/manual-testing/templates/<group>/MT-NNN-<name>/test-case.md -->
<!-- Replace all [PLACEHOLDERS] with actual values -->
<!-- Remove all instructional comments when creating the actual file -->

# Test Case: [MT-NNN] [TITLE]
...
- [ ] **Automated comparison**: Run `Verify-TestResult.ps1 -TestCase [MT-NNN]` — compares workspace against `expected/`

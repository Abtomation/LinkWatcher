...
E2E acceptance tests validate user-facing workflows that span multiple features. They require a running application instance and simulate real user actions. See [User Workflow Map](/doc/product-docs/technical/design/user-workflow-map.md) for workflow definitions.

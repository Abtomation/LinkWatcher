...
This context map provides a visual guide to the components and relationships relevant to the E2E Acceptance Test Execution task. Use this map to identify which components require attention and how they interact.
...
graph TD
    ...
    TestTracking[/Test Tracking/] --> Execution{{E2E Acceptance Test Execution}}
...
- **Test Tracking**: Identifies which groups need re-execution (`🔄 Needs Re-execution`) and tracks current status of all E2E acceptance tests
...
- [E2E Acceptance Test Execution Task](/doc/process-framework/tasks/03-testing/e2e-acceptance-test-execution-task.md) - Full task definition
- [E2E Acceptance Test Case Creation Task](/doc/process-framework/tasks/03-testing/e2e-acceptance-test-case-creation-task.md) - Upstream task creating test cases

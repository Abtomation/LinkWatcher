...
- [Framework Evaluation Task](/doc/process-framework/tasks/support/framework-evaluation.md) — Task definition for this evaluation process
- [Documentation Map](/doc/process-framework/documentation-map.md) — Central index of all framework artifacts
- [AI Tasks System](/doc/process-framework/ai-tasks.md) — Task registry and workflow definitions
- [Process Improvement Tracking](/doc/process-framework/state-tracking/permanent/process-improvement-tracking.md) — Where IMP entries are registered

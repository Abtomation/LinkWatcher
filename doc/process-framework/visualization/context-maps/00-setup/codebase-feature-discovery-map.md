...
- **[Feature Tracking](../../../../product-docs/state-tracking/permanent/feature-tracking.md)**: Permanent registry where all discovered features are added with IDs, descriptions, and status
...
3. **Feature Discovery Loop** (per feature):
   ...
   - Add feature to [Feature Tracking](../../../../product-docs/state-tracking/permanent/feature-tracking.md)
...
- [Codebase Feature Discovery Task (PF-TSK-064)](../../../tasks/00-setup/codebase-feature-discovery.md) - Full task definition with detailed process steps
- [Retrospective Master State Template](../../../templates/00-setup/retrospective-state-template.md) - Template structure and usage

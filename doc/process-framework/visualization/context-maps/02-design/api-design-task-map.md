...
- [API Data Model Creation Guide](/doc/process-framework/guides/02-design/api-data-model-creation-guide.md) - How to use the ../../scripts/file-creation/New-APIDataModel.ps1 script

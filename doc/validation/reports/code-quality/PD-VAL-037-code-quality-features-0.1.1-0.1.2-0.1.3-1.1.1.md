---
id: PD-VAL-037
description: "Batch 1 (Score: 3.050/4.0 PASS)"
...
1. **Continue handler.py decomposition (TD005)**
   ...
   - **Dependencies**: Existing refactoring plan in doc/refactoring/plans/archive/decompose-handle-file-moved-mega-method-into-focused-sub-methods.md
...
2. **Migrate print() to logger across service.py and handler.py (TD026)**
   ...
   - **Dependencies**: Existing refactoring plan in doc/refactoring/plans/archive/remove-dual-print-logger-output-in-updater-py-td026.md

---
id: PD-VAL-036
description: "Batch 2 (Score: 3.450/4.0 PASS)"
...
- `src/linkwatcher/parser.py` — Parser Facade (~112 LOC)
- `src/linkwatcher/parsers/base.py` — Parser ABC (~77 LOC)
- `src/linkwatcher/parsers/markdown.py` — Markdown Parser (~242 LOC)
- `src/linkwatcher/parsers/yaml_parser.py` — YAML Parser (~102 LOC)
- `src/linkwatcher/parsers/json_parser.py` — JSON Parser (~90 LOC)
- `src/linkwatcher/parsers/python.py` — Python Parser (~121 LOC)
- `src/linkwatcher/parsers/dart.py` — Dart Parser (~191 LOC)
- `src/linkwatcher/parsers/generic.py` — Generic Parser (~133 LOC)
- `src/linkwatcher/parsers/__init__.py` — Package exports (~25 LOC)
- `src/linkwatcher/updater.py` — Link Updater (~633 LOC)
- `src/linkwatcher/logging.py` — Core Logging API (~510 LOC)
- `src/linkwatcher/logging_config.py` — Advanced Logging Config (~439 LOC)

...
> **📋 Primary Documentation**: [TDD PD-TDD-021](../../technical/tdd/tdd-0-1-1-core-architecture-t3.md)
>
...
- **0.1.1-EC-5**: Rapid successive file operations (e.g., IDE rename) use a 10-second pending-delete timer (configurable via `move_detect_delay`) to correctly detect moves vs. separate create/delete events

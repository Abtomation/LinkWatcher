...
> **📋 Primary Documentation**: [TDD PD-TDD-024](../../technical/tdd/tdd-3-1-1-logging-framework-t2.md)
>
...
- **3.1.1-BR-1**: Console output uses ANSI color coding by level: DEBUG=cyan, INFO=green, WARNING=yellow, ERROR=red, CRITICAL=bright magenta

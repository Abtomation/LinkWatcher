...
3. **Identify new workflows**: If this feature enables a new user-visible workflow, note it for addition to the workflow tracking file
   ...
   |----------|-----------------|
   | WF-001   | Detects file system events and correlates delete+create into moves |
   | WF-002   | Batches per-file events into directory-level move operations |
   ```

**Expected Result:** Feature's workflow context documented, enabling downstream tasks (implementation, validation, maintenance) to understand cross-feature dependencies
...
### 6. Identify Edge Cases and Error Handling
...
- [FDD Template](../../templates/02-design/fdd-template.md) - The template this guide helps customize

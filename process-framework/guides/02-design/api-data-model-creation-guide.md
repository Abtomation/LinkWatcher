...
- [New-APIDataModel.ps1 Script](../../scripts/file-creation/02-design/New-APIDataModel.ps1) - Script for creating API data models
- [API Data Model Template](../../templates/02-design/api-data-model-template.md) - Template customized by this guide

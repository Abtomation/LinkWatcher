...
3. **Implementation**
   ...
   - Follow the [Definition of Done](definition-of-done.md) criteria
...
- **Tier 2 (🟠)**: Create a lightweight TDD using the [Lightweight Template](../../templates/02-design/tdd-t2-template.md)
- **Tier 3 (🔴)**: Create a full TDD using the [Full Template](../../templates/02-design/tdd-t3-template.md)
...
> **Example**: Feature 1.1.1 (File System Monitoring) participates in WF-001 through WF-006. Changing event handling in this feature could affect single file moves, directory moves, startup scans, rapid sequential moves, multi-format moves, and configuration changes — all of which need regression testing.

...
- Access to PowerShell and the New-DebtItem.ps1 script in `process-framework/assessments`
...
1. **Open the created debt item file** for editing:
   ...
   code "process-framework/assessments/technical-debt/debt-items/PF-TDI-XXX-your-item-title.md"
   ```
...
1. Ensure you're running the script from `process-framework/assessments`
...
- [Technical Debt Tracking](../../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md) - Central tracking for all technical debt items

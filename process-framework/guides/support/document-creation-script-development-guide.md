...
- process-framework/scripts/Common-ScriptHelpers.psm1
- `process-framework/scripts/IdRegistry.psm1`
...
1. **Copy the Template**:
   ...
   ```powershell
   Copy-Item "process-framework/templates/support/document-creation-script-template.ps1" "process-framework/scripts/file-creation/New-YourScript.ps1"
   ```

2. **Script Location**: All document creation scripts should be placed in the `process-framework/scripts/file-creation` directory to maintain consistency and make them easier to find.
...
```json
{
  "prefixes": {
    "PF-TSK": {
      ...
      "directories": {
        "01-planning": "process-framework/tasks/01-planning",
        "02-design": "process-framework/tasks/02-design",
        "03-testing": "process-framework/tasks/03-testing",
        "04-implementation": "process-framework/tasks/04-implementation",
        "05-validation": "process-framework/tasks/05-validation",
        "06-maintenance": "process-framework/tasks/06-maintenance",
        "07-deployment": "process-framework/tasks/07-deployment",
        "continuous": "process-framework/tasks/continuous",

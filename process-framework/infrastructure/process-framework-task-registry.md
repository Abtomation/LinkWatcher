...
| --------------------------------------------------------------------------------------------------- | ------------------- | ------------------- |
| [Feature Tracking](../../doc/product-docs/state-tracking/permanent/feature-tracking.md)                                 | 16+ tasks           | **CRITICAL**        |
| [Bug Tracking](../../doc/product-docs/state-tracking/permanent/bug-tracking.md)                                         | 10+ tasks           | **HIGH**            |
| [Test Tracking](../../test/state-tracking/permanent/test-tracking.md)         | 4 tasks             | **HIGH**            |
| [Architecture Tracking](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md)                       | 4 tasks             | **HIGH**            |
| [Technical Debt Tracking](../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md)                   | 3 tasks             | **MEDIUM**          |
...
| [Validation Tracking](../../doc/product-docs/state-tracking/temporary/validation/archive/validation-tracking-1.md) | 6 validation tasks  | **MEDIUM**          |
...
- **Output Directory:** [`assessments/`](../../doc/product-docs/documentation-tiers/assessments)
...
- **Output Directory:** [`fdds/`](../../doc/product-docs/functional-design/fdds)
...
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-FDD.ps1` | Status: "📊 Assessment Created" → "📋 FDD Created"<br/>• Add FDD document link in FDD column<br/>• Add FDD creation date to Notes |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Advances feature documentation workflow
...
- **Output Directory:** [`tdd/`](../../doc/product-docs/technical/architecture/design-docs/tdd)
- **Auto-Update Function:** Built-in automated feature tracking updates
...
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-tdd.ps1` | Status: "📋 FDD Created" (Tier 2+) or "📊 Assessment Created" (Tier 1) → "📝 TDD Created"<br/>• Add TDD link in Tech Design column<br/>• Add TDD creation date to Notes column |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Completes technical design phase
...
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-TestSpecification.ps1` | Status: "🏗️ Architecture Reviewed" → "📋 Specs Created"<br/>• Add Test Spec link in Test Spec column<br/>• Add specification creation date to Notes |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Updates feature test status
...
| **Updates** | [`bug-tracking.md`](../../doc/product-docs/state-tracking/permanent/bug-tracking.md) (if bugs discovered) | [`New-BugReport.ps1`](../scripts/file-creation/06-maintenance/New-BugReport.ps1)| Add newly discovered bugs with 🆕 Reported status for triage |
...
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-TestFile.ps1` | Update Test Status based on implementation progress<br/>• Automatic status mapping from test implementation to feature tracking<br/>• Coordinate status across multiple state files |
...
- **Secondary coordination:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Updates feature test status
...
- **Output Directory:** [`test-audits/`](../../doc/product-docs/test-audits)
...
- **Intelligent aggregation:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Automated feature-level test status based on all test files
...
- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Core feature development tracking
...
| **Updates** | [Feature Implementation State Files](../../doc/product-docs/state-tracking/features) | Manual | Code inventory, task sequence, implementation notes, issues log |
| **Updates** | [Feature Tracking](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | Manual | Status → 🧪 Testing |
...
| **Updates** | [Bug Tracking](../../doc/product-docs/state-tracking/permanent/bug-tracking.md) | Manual | Bug entries if bugs discovered (optional) |
...
| **Updates** | [`validation-tracking.md`](../../doc/product-docs/state-tracking/temporary/validation/archive/validation-tracking-1.md) | [`Run-FoundationalValidation.ps1`](../scripts/validation/Run-FoundationalValidation.ps1) | Update validation matrix with report creation dates and links |
| **Updates** | [`bug-tracking.md`](../../doc/product-docs/state-tracking/permanent/bug-tracking.md) (if bugs discovered) | [`New-BugReport.ps1`](../scripts/file-creation/06-maintenance/New-BugReport.ps1)| Add newly discovered bugs with 🆕 Reported status for triage |
...
| **Updates** | [`architecture-tracking.md`](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md) | Manual | Record foundation implementation and architectural evolution<br/>• Update component status and key decisions |
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | Manual | Update with foundation feature completion status |

**🎯 KEY IMPACTS**

- **Primary state file:** [`architecture-tracking.md`](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md) - Tracks foundational architectural changes
- **Secondary coordination:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Updates feature completion status
...
- **Output Directory:** [`adr/`](../../doc/product-docs/technical/architecture/design-docs/adr/adr)
...
| **Updates** | [`architecture-tracking.md`](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md) | `New-ArchitectureDecision.ps1` | Update with new architectural decision and its impact<br/>• Record decision context and consequences |
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-ArchitectureDecision.ps1` | Update ADR column for related features with link to created ADR |
...
- **Primary state file:** [`architecture-tracking.md`](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md) - Records architectural decisions
- **Secondary coordination:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Links decisions to features
...
- **Output Directory:** [`specifications/`](../../doc/product-docs/technical/api/specifications/specifications) + [`models/`](../../doc/product-docs/technical/api/models)
...
| **Updates** | [`technical-debt-tracking.md`](../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md) | Manual | Record API design decisions that create technical debt |
...
- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - **FULLY AUTOMATED** API design completion tracking
...
- **Output Directory:** [`schemas/`](../../doc/product-docs/technical/database/schemas) + [`migrations/`](../../doc/product-docs/technical/database/migrations) + [`diagrams/`](../../doc/product-docs/technical/database/diagrams)
- **Auto-Update Function:** Built-in automated feature tracking updates
...
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-SchemaDesign.ps1` | Update DB Design column from "Yes" to link to completed schema design<br/>• Add schema design document link in DB Design column<br/>• Add schema design creation date to Notes |
| **Updates** | [`technical-debt-tracking.md`](../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md) | Manual | Add schema optimization opportunities identified during design |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Completes database design requirement with automated state updates
- **Technical debt tracking:** [`technical-debt-tracking.md`](../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md) Documents schema optimization opportunities (manual update required)
...
- **Output Directory:** [`design/ui-ux/`](../../doc/product-docs/technical/design/ui-ux) with subdirectories:
...
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-UIDesign.ps1` | Update UI Design column from "TBD" to link to completed UI design<br/>• Add UI design document link in UI Design column<br/>• Add design creation date to Notes |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Completes UI/UX design requirement with automated state updates
...
|-----------|-----------|---------------|---------|
| **Updates** | [`bug-tracking.md`](../../doc/product-docs/state-tracking/permanent/bug-tracking.md) (if bugs discovered) | [`New-BugReport.ps1`](../scripts/file-creation/06-maintenance/New-BugReport.ps1)| Add newly discovered bugs with 🆕 Reported status for triage |
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | Manual | Update code review status (🟢 Completed/🔄 Needs Revision)<br/>• Add review date, reviewer information<br/>• Link to review document, list major findings |
...
- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Quality gate for feature completion
...
- **Primary state file:** [`bug-tracking.md`](../../doc/product-docs/state-tracking/permanent/bug-tracking.md) - Tracks bug resolution progress through complete lifecycle with automated state management
...
- **Output Directory:** [`plans/`](../../doc/product-docs/refactoring/plans), [`temporary/`](../state-tracking/temporary/)
...
| **Updates** | [`bug-tracking.md`](../../doc/product-docs/state-tracking/permanent/bug-tracking.md) | [`New-BugReport.ps1`](../scripts/file-creation/06-maintenance/New-BugReport.ps1) | Add bugs discovered during refactoring with 4-tier severity decision matrix |
| **Updates** | [`technical-debt-tracking.md`](../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md) | [`Update-TechDebt.ps1`](../scripts/update/Update-TechDebt.ps1) | Status transitions: Open → InProgress → Resolved/Rejected (auto-moves to Recently Resolved) |
| **Updates** | [`architecture-tracking.md`](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md) | Manual | Improve feature status (e.g., "🔄 Needs Revision" → "🧪 Testing") |
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | Manual | For foundation features (0.x.x), document architectural improvements |
...
- **Primary state file:** [`technical-debt-tracking.md`](../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md) - Comprehensive 3-phase debt resolution tracking
- **Secondary coordination:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Updates feature quality status with clear progression path
...
|-----------|-----------|---------------|---------|
| **Updates** | [`bug-tracking.md`](../../doc/product-docs/state-tracking/permanent/bug-tracking.md) (if bugs discovered) | [`New-BugReport.ps1`](../scripts/file-creation/06-maintenance/New-BugReport.ps1)| Add newly discovered bugs with 🆕 Reported status for triage |
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | Manual | Update deployment status for released features<br/>• Add release version and deployment date |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Tracks feature deployment status
...
- **Output Directory:** [`doc/product-docs/user/handbooks/`](../../doc/product-docs/user/handbooks)
...
- **Output Directory:** [`assessments/`](../../doc/product-docs/technical/architecture/assessments)
...
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | `New-ArchitectureAssessment.ps1` | Status: "📋 FDD Created" → "🏗️ Architecture Reviewed"<br/>• Add Architecture Impact Assessment link in Arch Review column<br/>• Add architecture review completion date to Notes |
| **Updates** | [`architecture-tracking.md`](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md) | `New-ArchitectureAssessment.ps1` | Add new architecture impact entry with assessment details and cross-references |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Advances feature through architecture review phase
- **Secondary coordination:** [`architecture-tracking.md`](../../doc/product-docs/state-tracking/permanent/architecture-tracking.md) - Tracks architectural decisions and impacts
- **Enables next steps:** Test Specification Creation, API Design, Database Schema Design
...
| Operation | File Path | Update Method | Details |
|-----------|-----------|---------------|---------|
| **Updates** | [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) | Manual | Add new feature entries with initial status "⬜ Not Started" |

**🎯 KEY IMPACTS**

- **Primary state file:** [`feature-tracking.md`](../../doc/product-docs/state-tracking/permanent/feature-tracking.md) - Initiates feature development workflow
...
| **Updates** | [`validation-tracking.md`](../../doc/product-docs/state-tracking/temporary/validation/archive/validation-tracking-1.md) | Auto | Update validation matrix with report creation date and link<br/>• Update specific validation type column for validated features |
...
- **Primary state file:** [`validation-tracking.md`](../../doc/product-docs/state-tracking/temporary/validation/archive/validation-tracking-1.md) - Tracks validation completion across features
...
- **Primary state file:** [`technical-debt-tracking.md`](../../doc/product-docs/state-tracking/permanent/technical-debt-tracking.md) - **FULLY AUTOMATED** technical debt inventory with assessment traceability

...
**Location**: `doc/product-docs/state-tracking/permanent/user-workflow-tracking.md`
**ID**: PD-DES-002
...
**Add**: "Identify user-facing workflows — ask 'What does the user DO with this software?' Map each workflow to the features that enable it. Create/update User Workflow Map (`doc/product-docs/state-tracking/permanent/user-workflow-tracking.md`)."
**Output**: Add User Workflow Map to task outputs
**State files**: Add `user-workflow-tracking.md` to state tracking section
...
**Output**: Add User Workflow Map to task outputs
**State files**: Add `user-workflow-tracking.md` to updated files list
...
- Update the "Source of Truth Files" table to include `user-workflow-tracking.md`
...
- [ ] Create User Workflow Map for LinkWatcher (`doc/product-docs/state-tracking/permanent/user-workflow-tracking.md`)
...
- [ ] process-framework/ai-tasks.md shows milestone-triggered E2E workflow
...
- [ ] **Workflow map as artifact**: Agree with single `user-workflow-tracking.md` in `doc/product-docs/technical/design/` (no separate template/script)?
...
- [ ] **Session 3 scope**: 7 tasks + 4 guides + process-framework/ai-tasks.md — achievable in one session?

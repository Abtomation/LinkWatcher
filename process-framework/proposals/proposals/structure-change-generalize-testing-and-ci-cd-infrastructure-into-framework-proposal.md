...
- FDD in `product-docs/functional-design/fdds/`
- TDD in `product-docs/technical/architecture/design-docs/tdd/`
...
- `product-docs/functional-design/fdds/fdd-4-1-1-test-suite.md`
- `product-docs/functional-design/fdds/fdd-5-1-1-cicd-development-tooling.md`
- `product-docs/technical/architecture/design-docs/tdd/tdd-4-1-1-test-suite-t2.md`
- `product-docs/technical/architecture/design-docs/tdd/tdd-5-1-1-cicd-development-tooling-t2.md`
...
- `documentation-map.md` — Update references, add new guides
...
- Update documentation-map.md to reference new guides instead
...
- No broken cross-references in documentation-map.md
...
3. Revert documentation-map.md changes

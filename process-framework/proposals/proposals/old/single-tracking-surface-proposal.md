...
1. **[feature-tracking.md](../../../../doc/product-docs/state-tracking/permanent/feature-tracking.md)** — master table with one row per feature, columns for each document type
2. **Individual feature state files** (e.g., [0.1.1-core-architecture-implementation-state.md](../../../../doc/product-docs/state-tracking/features/0.1.1-core-architecture-implementation-state.md)) — Section 4 "Documentation Inventory" tables

...
| File | Change |
|------|--------|
| `process-framework/scripts/validation/validate-id-registry.ps1` | Scan all three registry files |
...
| `process-framework/documentation-map.md` | Update all references to renamed prefixes (PF-VAL-035 → PD-VAL-035, PF-TSP-035 → TE-TSP-035, etc.) |

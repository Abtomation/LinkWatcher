...
Create `process-framework/guides/framework/development-dimensions-guide.md` as the **single authoritative reference** for all 10 dimensions across all task phases.

...
**Location**: `doc/state-tracking/permanent/user-workflow-tracking.md`
**ID**: PD-DES-002
...
**Add**: "Identify user-facing workflows — ask 'What does the user DO with this software?' Map each workflow to the features that enable it. Create/update User Workflow Map (`doc/state-tracking/permanent/user-workflow-tracking.md`)."
...
- [ ] Create User Workflow Map for LinkWatcher (`doc/state-tracking/permanent/user-workflow-tracking.md`)
...
- [ ] **Workflow map as artifact**: Agree with single `user-workflow-tracking.md` in `doc/technical/design` (no separate template/script)?

...
- **Reference Only (Access When Needed):**
  - **Architecture Decision Records** - [ADR Directory](../../../doc/technical) - Data-related architectural decisions
...
- **Data Integrity Validation Report** - Detailed validation report with scoring and findings, created in doc/validation/reports/data-integrity/PF-VAL-XXX-data-integrity-features-[feature-range].md

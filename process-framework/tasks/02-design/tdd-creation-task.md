...
14. **MANDATORY: Include Quality Attribute Sections** in all TDDs:
...
15. Include specific "AI Agent Session Handoff Notes" section in all documents with:
...
16. Ensure the documentation includes appropriate diagrams or visual aids:
...
17. **🚨 CRITICAL**: Actively request feedback from your human partner during TDD creation:
...
18. **🚨 CHECKPOINT**: Present completed TDD draft including workflow context, dimension-informed quality attribute sections, diagrams, and handoff notes to human partner for review and approval

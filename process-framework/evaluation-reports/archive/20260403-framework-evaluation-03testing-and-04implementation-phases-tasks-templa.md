...
| S-3 | Hardcoded output directories in several scripts (e.g., "feature-specs/", "implementation-plans/") not configurable | Low | scripts/file-creation/03-testing/New-TestSpecification.ps1, scripts/file-creation/04-implementation/New-ImplementationPlan.ps1 |

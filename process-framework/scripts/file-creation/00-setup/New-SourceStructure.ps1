...
"@
        ...
        $configPattern = '(?s)\| Setting \| Value \|.*?\| Shared directory \| \[From languages-config directoryStructure\.sharedDirectory\] \|'
        ...
        $treePattern = '(?s)\[Generated by New-SourceStructure\.ps1\]'

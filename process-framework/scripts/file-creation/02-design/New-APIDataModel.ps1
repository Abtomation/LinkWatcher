...
.NOTES
    ...
    - The API Data Model template (process-framework/templates/02-design/api-data-model-template.md)
...
try {
    ...
    $templatePath = Join-Path $projectRoot "process-framework/templates/02-design/api-data-model-template.md"
    ...
    if (-not $OpenInEditor) {
        $details += @(
            ...
            "process-framework/guides/02-design/api-data-model-creation-guide.md",

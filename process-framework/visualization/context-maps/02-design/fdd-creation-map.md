...
created: 2025-08-01
updated: 2025-08-01
related_task: PF-TSK-027
description: "Components for creating Functional Design Documents"
---
...
graph TD
    ...
    FDD --> Script[[../../../scripts/file-creation/02-design/New-FDD.ps1](../../../scripts/file-creation/02-design/New-FDD.ps1) Script]
...
- **[../../../scripts/file-creation/02-design/New-FDD.ps1](../../../scripts/file-creation/02-design/New-FDD.ps1) Script**: Automated script that creates FDD documents with proper metadata and structure
...
2. **FDD Creation → [../../../scripts/file-creation/02-design/New-FDD.ps1](../../../scripts/file-creation/02-design/New-FDD.ps1) Script**: Task execution uses the script to create structured FDD documents with proper metadata
3. **[../../../scripts/file-creation/02-design/New-FDD.ps1](../../../scripts/file-creation/02-design/New-FDD.ps1) Script → FDD Template**: Script populates the template with feature-specific information and creates the document
...
3. **Run [../../../scripts/file-creation/02-design/New-FDD.ps1](../../../scripts/file-creation/02-design/New-FDD.ps1) Script**: Create the FDD document structure with proper Feature ID and metadata

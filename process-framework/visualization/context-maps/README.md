...
2. Follow the [Visual Notation Guide](../../guides/support/visual-notation-guide.md)
...
- [Visual Notation Guide](../../guides/support/visual-notation-guide.md) - Standard notation used in context maps

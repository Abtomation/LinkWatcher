...
> **🔗 Link**: Design System Guidelines (project-specific, create at `doc/technical/design/ui-ux/design-system/design-guidelines.md`) > **👤 Owner**: Design System
>
...
| ------ | --------------- | --------------------- | ----------------- |
| [Date] | [Decision made] | [Why this was chosen] | [What it affects] |

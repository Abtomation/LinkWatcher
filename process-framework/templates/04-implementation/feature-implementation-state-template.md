...
>
> **Content Type column** values are the project's declared L1 subdirectories from [PD-id-registry.json](../../../doc/PD-id-registry.json) (`PD-UGD.subdirectories.values`). Framework default: `tutorials`, `how-to`, `reference`, `explanation` (Diátaxis).

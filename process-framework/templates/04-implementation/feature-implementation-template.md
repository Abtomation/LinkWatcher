...
**Documentation Tier**: [Tier 1 🔵 / Tier 2 🟠 / Tier 3 🔴] (See [Documentation Tiers](../../../doc/product-docs/documentation-tiers/README.md))
...
- [ ] Updated feature status in [feature tracking document](../../../doc/product-docs/state-tracking/permanent/feature-tracking.md) to "In Progress" 🟡
...
- [ ] Updated feature status in [feature tracking document](../../../doc/product-docs/state-tracking/permanent/feature-tracking.md) to "Completed" 🟢

...
- [ ] **Task Usage Guide**: Create guide using New-Guide.ps1 and documentation-guide.md
  ...
  - **Command**: `cd process-framework/scripts/file-creation/support && .\New-Guide.ps1 -GuideTitle "[Task Name] Usage Guide" -SubDirectory "[phase-directory]" -GuideDescription "Comprehensive guide for using the [Task Name] task effectively"`

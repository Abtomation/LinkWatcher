...
- **[IMP-XXX]** ([HIGH/MEDIUM/LOW]): [Brief description]
...
<!-- Identify patterns that appear across multiple task groups. Include task group references and frequency. -->
...
|----|-------------|----------|-------------|-----------|
| IMP-[XXX] | [Description] | [HIGH/MEDIUM/LOW] | [PF-TSK-XXX] | [N]/[total] forms |

**Totals**: [N] HIGH, [N] MEDIUM, [N] LOW

---

## Human User Feedback

<!-- Collect and document direct user feedback from the review session. This is MANDATORY per PF-TSK-010. -->

| # | Feedback | Source |
|---|----------|--------|
| 1 | [Direct quote or paraphrase] | [Task/form reference] |

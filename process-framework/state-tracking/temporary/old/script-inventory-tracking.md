...
```powershell
Move-Item "process-framework/state-tracking/temporary/script-inventory-tracking.md" `
          "process-framework/state-tracking/temporary/old/script-inventory-tracking.md"
```

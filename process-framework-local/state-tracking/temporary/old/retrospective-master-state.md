...
| process-framework/ai-tasks.md | AI task system | 0.1.1 | ✅ |
| process-framework/.ai-entry-point.md | AI entry point marker | 0.1.1 | ✅ |
...
- Populated Code Inventories for 9 features with clickable markdown links (`../../../../doc` relative paths)
...
1. New-tdd.ps1: Template paths pointed to `process-framework/templates/templates` instead of `process-framework/templates/templates`

...
created: 2026-03-22
updated: 2026-03-22
change_name: generalize-testing-and-cicd-into-framework
---

# Structure Change State: Generalize Testing and CICD into Framework
...
- **Change Name**: Generalize Testing and CICD into Framework
...
- **Scope**: Move Features 4.1.1 and 5.1.1 from feature tracking into process framework as reusable templates and guides. Proposal: PF-PRO-009.
...
- [ ] **Template Updates**: Update or create new templates using established processes
  ...
  - **Process**: Use [New-Template.ps1](../../../../process-framework/scripts/file-creation/support/New-Template.ps1) for new templates, follow [Template Development Guide](../../../../process-framework/guides/support/template-development-guide.md) for updates
...
- [ ] **Script Updates**: Update or create automation scripts
  ...
  - **Process**: Use [Document Creation Script Development Guide](../../../../process-framework/guides/support/document-creation-script-development-guide.md)
...
- [ ] **Guide Updates**: Update documentation guides
  ...
  - **Process**: Use [New-Guide.ps1](../../../../process-framework/scripts/file-creation/support/New-Guide.ps1) for new guides

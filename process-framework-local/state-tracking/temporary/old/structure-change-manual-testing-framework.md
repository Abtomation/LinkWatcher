...
- **Proposal Document**: [Structure Change Proposal](/process-framework-local/proposals/old/structure-change-manual-testing-proposal.md)
...
- [x] **Structure Change Proposal**: Created comprehensive proposal document
  - **Status**: COMPLETED
  - **Location**: `/process-framework-local/proposals/structure-change-manual-testing-proposal.md`
...
**Delegated to**: [New Task Creation Process (PF-TSK-001)](../../../../process-framework/tasks/support/new-task-creation-process.md) — Full Mode (all sessions consolidated into one)
...
- [x] **Delegate: Create Manual Test Execution task** → [PF-TSK-001](../../../../process-framework/tasks/support/new-task-creation-process.md) Lightweight Mode
  - **Status**: COMPLETED
...
- [x] **Create execution scripts** (direct)
  - **Status**: COMPLETED
  - **Location**: `process-framework/scripts/testing`
  - **Scripts**:
...
- [x] **Documentation updates**: ../documentation-map.md updated with task, context map, 3 scripts; process-framework/ai-tasks.md and ../tasks/README.md auto-updated and link-fixed
...
| TC-002 | New tasks registered in process-framework/ai-tasks.md | Both new tasks appear in 03-testing section | PF-TSK-069 + PF-TSK-070 both registered with -task suffix links | PASSED |
...
- [ ] **Functional Criteria**:
  ...
  - [ ] All new tasks registered in process-framework/ai-tasks.md and ../documentation-map.md

...
> **Temporary file** — move to `process-framework-local/state-tracking/temporary/old` when all sessions complete.

## Overview

- **Source**: [PF-IMP-258](/process-framework-local/state-tracking/permanent/process-improvement-tracking.md)
- **Concept Document**: [PF-PRO-013](/process-framework-local/proposals/old/workflow-level-framework-layer.md)

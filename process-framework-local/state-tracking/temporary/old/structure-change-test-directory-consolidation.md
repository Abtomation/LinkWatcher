...
- **Change ID**: SC-006
- **Proposal Document**: [Structure Change Proposal (PF-PRO-006)](/process-framework-local/proposals/old/structure-change-test-directory-consolidation-and-framework-integration-proposal.md)
...
| State File | `4.1.1-test-suite-implementation-state.md` | `process-framework-local/state-tracking/features` | Update all `tests/` → `test/automated/` paths | HIGH |
| State File | `test-tracking.md` | `process-framework-local/state-tracking/permanent` | Update audit report path references | HIGH |

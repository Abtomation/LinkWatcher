...
- **Change ID**: SC-008
- **Proposal Document**: [Structure Change Proposal PF-PRO-011](/process-framework-local/proposals/old/structure-change-split-id-registry-into-framework-and-product-registries-proposal.md)
...
| State tracking (product) | PF-STA → PD-STA | 27 | `process-framework-local/state-tracking` | SIMPLE |
| Review artifacts | ART-REV → PF-REV | 14 | `process-framework-local/feedback/reviews` | SIMPLE |
...
| State tracking (test) | PF-STA → TE-STA | 1 | `process-framework-local/state-tracking/permanent` → `test/` | MODERATE (move + rename) |
...
| `process-framework-local/state-tracking/permanent/test-tracking.md` | `test/test-tracking.md` | Move |
...
- [x] **Structure Change Proposal**: PF-PRO-011 created and approved
  - **Status**: COMPLETED
  - **Location**: [Proposal](/process-framework-local/proposals/old/structure-change-split-id-registry-into-framework-and-product-registries-proposal.md)
...
This state file moves to `process-framework-local/state-tracking/temporary/old` when:

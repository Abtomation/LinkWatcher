...
| U-3 | No automated template-to-script gap detection — the 28 templates without scripts can only be found by manual comparison | Medium | `process-framework/templates`, `sscripts/file-creation |

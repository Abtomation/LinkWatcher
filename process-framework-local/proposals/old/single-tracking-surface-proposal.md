...
| Status | Deferred |
| Source | [IMP-037 — Tools Review 2026-02-21](../../../process-framework-local/feedback/reviews/tools-review-20260221.md) |
...
1. **[feature-tracking.md](../../../doc/state-tracking/permanent/feature-tracking.md)** — master table with one row per feature, columns for each document type
2. **Individual feature state files** (e.g., [0.1.1-core-architecture-implementation-state.md](../../../doc/state-tracking/features/0.1.1-core-architecture-implementation-state.md)) — Section 4 "Documentation Inventory" tables
...
| Update | [documentation-map.md](../../PF-documentation-map.md) — mark ../feature-tracking.md as auto-generated |
...
# Source: process-framework/state-tracking/features/*.md
...
Select the **Process Improvement** task from [ai-tasks.md](/process-framework/ai-tasks.md) and follow the 3-session plan in Section 5.

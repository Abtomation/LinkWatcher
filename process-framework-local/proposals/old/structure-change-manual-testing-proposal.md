...
Template for `test-case.md` files. Located at `process-framework/templates/templates/manual-test-case-template.md`.
...
Template for group-level master tests. Located at `process-framework/templates/templates/manual-master-test-template.md`.
...
All scripts located in `process-framework/scripts/testing`.
...
process-framework/scripts/testing     # Testing automation scripts
...
2. **New task definitions**: Verify tasks are correctly registered in process-framework/ai-tasks.md and ../documentation-map.md

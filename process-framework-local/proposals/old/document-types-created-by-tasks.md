...
- **Assessment Document** (ART-ASS-XXX)
  - Location: `/doc/documentation-tiers/assessments`
...
- **Functional Design Document** (PD-FDD-XXX)
  - Location: `/doc/functional-design/fdds`
...
- **API Specification Document** (PD-API-XXX)
  - Location: `/doc/technical/api/specifications/specifications`
  - Format: `[api-name].md`
  - Content: API contracts, endpoints, authentication, error handling
- **Request Data Model**
  - Location: `/doc/technical/api/models`
...
- **UI/UX Design Document** (PD-UID-XXX)
  - Location: `/doc/technical/design/ui-ux/features`
...
- **Implementation Plan Document** (PD-IMP-XXX)
  - Location: `/doc/technical/implementation-plans`
...
- **Feature Implementation State File** (PF-FIS-XXX) - **PERMANENT**
  - Location: `/process-framework-local/state-tracking/features`
...
**File**: `/process-framework-local/state-tracking/temporary/retrospective-[feature-id]-state.md`

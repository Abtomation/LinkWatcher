...
- **Decision tree updated**: process-framework/ai-tasks.md gets a new branch for enhancement vs. new feature classification
...
- **Feature Tracking**: Current feature inventory to identify existing features ([feature-tracking.md](../../../doc/state-tracking/permanent/feature-tracking.md))
...
| Existing Design Docs (FDD, TDD, ADR) | Various doc/ locations | Reference during evaluation; amend during enhancement |
...
| Edit | process-framework/ai-tasks.md decision tree update | Add enhancement branch to task selection | HIGH |
| Edit | process-framework/ai-tasks.md task table update | Add new tasks to 01-planning and 04-implementation tables | HIGH |
...
| Edit | PF-documentation-map.md | Register new tasks, template, guide, and script | MEDIUM |

#### Integration Points

| Integration Point | Current Framework Component | Integration Method |
|------------------|----------------------------|-------------------|
| Task selection decision tree | process-framework/ai-tasks.md | Add "New Feature vs Enhancement" branch before "Are you working on a NEW FEATURE?" |
...
| Documentation map | PF-documentation-map.md | Add entries for new tasks, template, guide, and script |
...
- [ ] Update process-framework/ai-tasks.md decision tree with new enhancement branch
- [ ] Update process-framework/ai-tasks.md task tables with new tasks
- [ ] Update task-transition-guide.md with enhancement workflow transitions
- [ ] Add PF-TSK-004 deprecation notice
- [ ] Update PF-documentation-map.md with all new artifacts (tasks, template, guide, script)
...
- [ ] **Decision tree updated**: process-framework/ai-tasks.md routes users to the right workflow for both new features and enhancements
...
- [ ] **Documentation complete**: PF-documentation-map.md includes all new artifacts (tasks, template, guide, script)

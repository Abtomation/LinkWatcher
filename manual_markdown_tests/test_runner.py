...
def test_file(file_path):
    ...
    try:
        ...
        # Summary
        existing = [
            r for r in references if check_file_exists(r.link_target, base_dir) == "✅ EXISTS"
        ]
        missing = [
            r for r in references if check_file_exists(r.link_target, base_dir) == "❌ MISSING"
        ]
        external = [
            r for r in references if check_file_exists(r.link_target, base_dir) == "🌐 External"
        ]

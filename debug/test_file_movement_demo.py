...
def test_file_movement():
    ...
    if not test_dir.exists():
        print("❌ Manual test directory not found. Run 'python scripts/create_test_structure.py' first.")
        return
    ...
    print(f"   Database: {final_stats['total_references']} references to {final_stats['total_targets']} targets")
    print(f"   Operations: {handler_stats['files_moved']} moves, {handler_stats['links_updated']} links updated")
